  ...
  return (
    <>
      ...
      <div className="carousel-container">
        ...
        <div className="home">
          <img className='home' src="	https://thumb.tildacdn.com/tild3066-3936-4632-a234-396433303631/-/format/webp/4.png" alt="" />
          <img src="	https://thumb.tildacdn.com/tild6566-3934-4561-b235-343237663134/-/format/webp/55.png" alt="" />
        </div>
    </>
  )
}

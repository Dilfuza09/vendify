...
const About = () => {
  return (
    <div className="min-h-screen bg-[#F5F5F5] p-6 flex items-center justify-center p-10">
      <div className="bg-white shadow-md rounded-lg max-w-4xl w-full p-8 relative">
        ...
        >
          <h3 className="text-2xl font-semibold text-gray-800 mb-4">Meet our teachers who gave us knowledge</h3>
          <div className="flex justify-center gap-6">
            ...
            <div className="flex flex-col items-center">
              <img
                src="https://avatars.githubusercontent.com/u/99537396?v=4" // Замените на фото второго учителя
                alt="Teacher 2"
                className="w-24 h-24 rounded-full shadow-md mb-2"
              />
